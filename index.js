...
//Esta función envía la frase a nuestra aplicación en Wit para obtener la data procesada por el PLN
...
//Instanciamos un nuevo cliente de Wit
    ...
    .then((data) => { //En data obtenemos la respuesta de Wit (o sea la frase procesada por PLN)
      ...
      procesarFrase(data); //Llamamos a la función que nos va a procesar esa respuesta para obtener la intención identificada por el PLN
    })
    .catch(console.error);
  }
